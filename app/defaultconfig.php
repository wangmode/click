...
$configs = [
    ...
    // 扩展函数文件
    'extra_file_list'         => [CMF_PATH . 'common' . EXT, THINK_PATH . 'helper' . EXT, CMF_PATH . 'function' . EXT, CMF_PATH . 'functiontmpl' . EXT],
    // 默认输出类型
    ...
    'cmf_default_theme'       => 'text2',
    'cmf_admin_theme_path'    => 'themes/',
    'cmf_admin_default_theme' => 'admin_simpleboot3',


    'AccessKeyId' => 'LTAIImWbILXPRj8q',
    'AccessKeySecret' => 'FDHKIRXYhHYpdpCi6nQNSNCLaRIzjS',
    'EndPoint' => 'oss-cn-hongkong.aliyuncs.com',
    'bucket' => 'new-youzhantong',
    'siteUrl' => 'http://picture.yzt-tools.com',


    //宝塔面板 配置
    'BtKey'=>'Z2Qj3mghhMe6IBgSS9rTHiHeQjb8AXnF',
    'BtPanel'=>'http://yzt.youzhantong.cc:8888',
    ...
    'api_url'=>'http://yx.youzhantong.cc'
