...
class KeywordProductModel extends Model
{
     ...
     * @throws Exception
     */
    static public function newKeywordProduct($admin_id,$data)
    {
        foreach ($data as $key=>$val){
            ...
            $info['billing_time']   = self::getBillingDays($val['setmeal']);
            $info['keyword_id']     = KeywordModel::addKeyword( $list['keyword'],$val['customer_id'],$val['url']);
