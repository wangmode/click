...
class DailiBaseController extends BaseController
{
    ...
    public function _initializeView()
    {
        ...
        $cmfDefaultTheme = daili_get_current_theme();
    ...
    public function checkUserLogin()
    {
        ...
        if (empty($userId)) {
            if ($this->request->isAjax()) {
                $this->error("您尚未登录", cmf_url("agent/Login/index"));
            } else {
                $this->redirect(cmf_url("agent/Login/index"));
            }
        }
    }
